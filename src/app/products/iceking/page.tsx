...
export default function IceKingPage() {
    return (
        <div className="bg-[var(--color-bg)]">
            <Link href="/c/disposable" className="block mx-auto max-w-screen-xl px-4 py-3 text-xs text-[var(--color-fg-muted)] hover:text-[var(--color-fg)]">
                ← 일회용 카테고리
            </Link>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/page-iceking.png" alt="ICE KING" className="w-full block" />
            <div className="mx-auto max-w-screen-xl px-4 py-8 flex justify-center">
                <Link
                    href="/c/disposable"
